...
namespace Gremlin.Net.Process.Traversal
{
    ...
    public static class __
    {
        ...
        ///     Spawns a <see cref="GraphTraversal{SType, EType}" /> and adds the choose step to that traversal.
        /// </summary>
        public static GraphTraversal<object, E2> Choose<E2>(P choosePredicate, ITraversal trueChoice)
        {
        ...
        ///     Spawns a <see cref="GraphTraversal{SType, EType}" /> and adds the choose step to that traversal.
        /// </summary>
        public static GraphTraversal<object, E2> Choose<E2>(P choosePredicate, ITraversal trueChoice, ITraversal falseChoice)
        {
        ...
        ///     Spawns a <see cref="GraphTraversal{SType, EType}" /> and adds the emit step to that traversal.
        /// </summary>
        public static GraphTraversal<object, object> Emit(P emitPredicate)
        {
        ...
        /// </summary>
        public static GraphTraversal<object, object> Filter(P predicate)
        {
        ...
        /// </summary>
        public static GraphTraversal<object, object> Until(P untilPredicate)
        {
